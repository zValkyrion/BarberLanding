      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <Button className="bg-primary text-black hover:bg-primary/90 font-semibold px-6 py-2 glow-gold">
              Book Now
            </Button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 py-4 border-t border-border">
            <div className="flex flex-col space-y-4">
              ...
              <a href="#testimonials" className="text-foreground hover:text-primary transition-colors">Reviews</a>
              <a href="#contact" className="text-foreground hover:text-primary transition-colors">Contact</a>
              <Button className="bg-primary text-black hover:bg-primary/90 font-semibold mt-4">
                Book Now
              </Button>
            </div>
          </div>
